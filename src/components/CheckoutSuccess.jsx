  ...
  useEffect(() => {
    const applySubscription = async () => {
      ...
      try {
        ...
        for (
          let attempt = 1;
          attempt <= SESSION_CHECK_MAX_ATTEMPTS;
          attempt += 1
        ) {
          ...
          if (!response.ok || !payload?.success)
            throw new Error(
              payload?.message || "Unable to verify checkout session.",
            );
          ...
          if (attempt < SESSION_CHECK_MAX_ATTEMPTS)
            await new Promise((r) => setTimeout(r, SESSION_CHECK_RETRY_MS));
        }
    ...
    return (
      ...
      >
        ...
        <p style={{ color: "#666", fontSize: 14 }}>
          ...
          <a href="mailto:contact@porchpobox.com">contact@porchpobox.com</a> and
          we'll sort it out.
        </p>
        <Link
          to="/"
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 560, width: "100%", textAlign: "center" }}>
        ...
        >
          Your Porch P.O. Box subscription is now active. Start having packages
          delivered to your preferred partner location today.
        </p>
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontWeight: 600, fontSize: 15 }}>
                  {formatDate(summary.subscribedAt)}
                </div>
              </div>
        ...
        >
          ...
          {[
            {
              icon: "📍",
              text: "Make sure your preferred partner location is set in your profile.",
            },
            {
              icon: "📦",
              text: "Use your partner location's address when placing orders online.",
            },
            {
              icon: "🔔",
              text: "You'll receive an email notification as soon as a package is checked in for you.",
            },
          ].map((step, i) => (
            <div
              key={i}
