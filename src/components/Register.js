    ...
    <>
      ...
      {fromGoogle ? (
        <>
          ...
          >
            To complete registration, you must review and agree to the terms.
          </div>

          <div className="reg-google-signin-section">
            <p className="reg-hint">
              Review terms:{" "}
              <Link to="/terms/user">User Terms and Conditions</Link>
            </p>
            <label
      ...
      <form className="reg-form" onSubmit={handleRegister} noValidate>
        ...
        <div style={{ marginTop: "20px", textAlign: "center" }}>
          <button
            ...
            onMouseLeave={(e) => {
              e.target.style.opacity = loading || !termsAccepted ? "0.6" : "1";
            }}
          >
