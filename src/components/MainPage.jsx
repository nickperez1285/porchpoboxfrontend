        ...
        <div className="mp-inner">
          ...
          <div className="mp-grid">
            ...
            >
              ...
              {!isActiveMember && partnerProfile && (
                <p
                  style={{ marginTop: 20, color: "#888", fontStyle: "italic" }}
                >
          ...
          <div className="mp-banners">
            ...
            >
              ...
              <p className="mp-banner__text">
                Wish you had a Porch P.O. Box nearby? Tell a local business
                about us. If they partner with us, we will thank you with a full
